...
request.onload = function(){
    ...
    if(dados.USD.varBid < 0){
        document.getElementById("USD_ask").style.color = ' #008000	 ';
    }else{
        document.getElementById("USD_ask").style.color = ' #3CB371	 ';
    }
    ...
    if(dados.USD.varBid < 0){
        document.getElementById("EUR_ask").style.color = ' #008000	 ';
    }else{
        document.getElementById("EUR_ask").style.color = ' #3CB371	 ';
    }
    ...
    if(dados.USD.varBid < 0){
        document.getElementById("GBP_ask").style.color = ' #008000	 ';
    }else{
        document.getElementById("GBP_ask").style.color = ' #3CB371	 ';
    }
    ...
    if(dados.USD.varBid < 0){
        document.getElementById("JPY_ask").style.color = ' #008000	 ';
    }else{
        document.getElementById("JPY_ask").style.color = ' #3CB371	 ';
    }
    ...
    if(dados.USD.varBid < 0){
        document.getElementById("CHF_ask").style.color = ' #008000	 ';
    }else{
        document.getElementById("CHF_ask").style.color = ' #3CB371	 ';
    }
    ...
    if(dados.USD.varBid < 0){
        document.getElementById("BTC_ask").style.color = ' #008000	 ';
    }else{
        document.getElementById("BTC_ask").style.color = ' #3CB371	 ';
    }
